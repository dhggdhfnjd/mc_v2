...
const en = {
  ...
  buyerMap: "I want to sell", wantBuy: "I want to buy", products: "Products",
  ...
  checkNumbers: "Check the numbers", noBuyersNear: "No buyers within", wholeMap: "Whole map", zoomIn: "Zoom in", gpsFailed: "No GPS signal",
...
const sw: Dict = {
  ...
  buyerMap: "Nataka kuuza", wantBuy: "Nataka kununua", products: "Mazao",
  ...
  checkNumbers: "Kagua namba", noBuyersNear: "Hakuna wanunuzi ndani ya", wholeMap: "Ramani yote", zoomIn: "Karibia", gpsFailed: "Hakuna GPS",
  ...
  sound: "Sauti", on: "Imewashwa", off: "Imezimwa",
