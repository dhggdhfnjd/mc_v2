...
// straight to the map and becomes the default market for a new buyer post.
...
export default function Where({ active }: ScreenProps) {
  ...
  return (
    <Screen active={active} title={t("fromWhere")} sub={market(settings.marketId ?? DEFAULT_MARKET_ID).name} soft={{ c: t("ok") }} onKey={onKey}>
